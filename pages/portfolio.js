    ...
    <div className='bg-zinc-950 text-white dark:bg-white dark:text-black '>
      ...
      <main className=''>
        ...
        <section className='md:flex md:justify-center'>
          <div className="w-fit md:m-5 m-2"> <Image className='border-2 border-orange-500 rounded-sm transition ease-in-out delay-40 hover:-translate-y-1 hover:scale-110 duration-300' src="/p1.png" alt="Picture of the author" width={380} height={10} /> </div>
